...
import com.github.verhagen.atnb.core.CommandException;
import com.github.verhagen.atnb.core.CommandName;
import com.github.verhagen.atnb.core.domain.TaskIdentifier;
import com.github.verhagen.atnb.core.task.RepositoryTask;
import com.github.verhagen.atnb.core.textfield.UriIdentifierConverter;
...
public class BookTask extends RepositoryTask {
	...
	public BookTask(ActivityTrackerEventConfig atEventCfg, BookTaskConfig bookTaskCfg) {
		super(atEventCfg, bookTaskCfg, AbstractTask.createTaskIdentifier("book", Arrays.asList(CommandName.ADD.name())));
